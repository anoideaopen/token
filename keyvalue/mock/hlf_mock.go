...
func (m *MockChaincodeStubInterface) PurgePrivateData(collection, key string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PurgePrivateData", collection, key)
	ret0, _ := ret[0].(error)
	return ret0
}

// PurgePrivateData indicates an expected call of PurgePrivateData.
func (mr *MockChaincodeStubInterfaceMockRecorder) PurgePrivateData(collection, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PurgePrivateData", reflect.TypeOf((*MockChaincodeStubInterface)(nil).PurgePrivateData), collection, key)
}
